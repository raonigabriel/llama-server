...
| Tag | Target Hardware | CPU Optimizations | GPU | Base OS |
| :--- | :--- | :--- | :--- | :--- |
| `opi5` | Orange Pi 5 / RK3588 | ARM NEON (SIMD) | No | Alpine |
| `morefine` | Celeron N5105 / Older x86 | SSE4.2 (`x86-64-v2`) | No | Alpine |
| `xeon-cuda` | Xeon v3 + RTX 30/40 Series | AVX2/FMA (`x86-64-v3`) | CUDA 13.2 | Ubuntu 24.04 |
| `windows-v3-cuda` | Modern PC + RTX GPU | AVX2 | CUDA 13.2 | Standalone `.exe` |
